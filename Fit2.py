...
trainXGenerator = image.getImageGeneratorFromDirectory(trainXDir, targetSize, 'L', trainBatchSize)
print('Start loading trainY.')
trainYGenerator = image.getImageGeneratorFromDirectory(trainYDir, targetSize, 'RGB', trainBatchSize)
print('Start loading validX.')
validXGenerator = image.getImageGeneratorFromDirectory(validXDir, targetSize, 'L', validBatchSize)
print('Start loading validY.')
validYGenerator = image.getImageGeneratorFromDirectory(validYDir, targetSize, 'RGB', validBatchSize)
print('Start generating train.')
trainGenerator = zip(trainXGenerator, trainYGenerator)
print('Start generating valid.')
validGenerator = zip(validXGenerator, validYGenerator)
